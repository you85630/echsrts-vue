    ...
    <div class="tab-nav">
      <div class="nav-list" id="navbox">
        ...
        <div class="tab-box" :style="{marginLeft:mleft+'px'}" id="tabbox">
          <div class="tab" v-for="(li,index) in list" :key="index">
            <div class="link" @click="linkTab(li)" :class="{active:li.link===active}">
              <span></span>
              <p>{{li.label}}</p>
            </div>
      ...
      <div class="close-box">
        ...
        <div class="btn" v-if="closeshow" @click="hideBox" @mouseleave="hideBox">
